...
import mistsImage from "../Image/exportbodymist";
...
class BodyMists extends React.Component {
  state = {
    urls: mistsImage,
    selectedImage: {}
  };
      ...
      <React.Fragment>
        <div className="linkMain">
          ...
          <div className="pageTitle">
            <h1>
              <span className="pageTitleBodyCream">Select Body Mists</span>
            </h1>
...
export default withStyles(useStyles)(BodyMists);
